...
<div id="wrapper">
    ...
    <div class="content-page">
        <div class="content">
            ...
            <h1 style="color: #1c304e">Edit product</h1>
            ...
            <div>
                <form method="post" enctype="multipart/form-data">
                    <div class="col-6 col-sm-6 form-group">
                        ...
                        <input type="file" required class="form-control" id="imageUrl" name="imageUrl" accept="image/png, image/jpeg" value="${requestScope['product'].imageUrl}">
                    </div>
                    <div class="col-6 col-sm-6 form-group">
                        <label for="name" class="form-label">Name</label>
                        <input type="text" required class="form-control" id="name" name="name" value="${requestScope['product'].name}">
                    </div>
                    <div class="col-6 col-sm-6 form-group">
                        <label for="price" class="form-label">Price</label>
                        <input type="number" required min="1000" max="10000000" class="form-control" id="price" name="price" value="${requestScope['product'].price}">
                    </div>
                    <div class="col-6 col-sm-6 form-group">
                        <label for="quantity" class="form-label">Quantity</label>
                        <input type="number" required min="1" max="1000" class="form-control" id="quantity" name="quantity" value="${requestScope['product'].quantity}">
                    </div>
            ...
            <div>
                <c:if test="${requestScope['isSuccess'] == true}">
                    <ul class="success" style="color: #00cb1f">
                        <li>Product is updated successful!</li>
                    </ul>
                </c:if>
