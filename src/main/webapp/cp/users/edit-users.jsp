                ...
                <div>
                    <form method="post">
                        <div class="col-4 col-sm-8 form-group">
                            ...
                            <input type="text" required class="form-control" id="name" name="name" value="${requestScope['user'].name}" maxlength="100">
                        </div>
                        <div class="col-4 col-sm-8 form-group">
                            <label for="phone" class="form-label">Phone</label>
                            <input type="tel" required class="form-control" id="phone" name="phone" value="${requestScope['user'].phone}" maxlength="20">
                        </div>
                        <div class="col-4 col-sm-8 form-group">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" required class="form-control" id="email" name="email" value="${requestScope['user'].email}" maxlength="100">
                        </div>
                        <div class="col-4 col-sm-8 form-group">
                            <label for="address" class="form-label">Address</label>
                            <input type="text" required class="form-control" id="address" name="address" value="${requestScope['user'].address}" maxlength="255">
                        </div>
                ...
                <div>
                    <c:if test="${requestScope['isSuccess'] == true}">
                        <ul class="success" style="color: #00cb1f">
                            <li>User is updated successful!</li>
                        </ul>
                    </c:if>
